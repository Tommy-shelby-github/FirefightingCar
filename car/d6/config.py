...
#STEERING_DOWN      下面的云台舵机
STEERING_DOWN_CHANNEL = 2            #channel on the 9685 pwm board 0-15
STEERING_DOWN_LEFT_PWM = 600         #pwm value for full left steering
STEERING_DOWN_RIGHT_PWM = 100        #pwm value for full right steering

#STEERING_UP        上面的云台舵机
STEERING_UP_CHANNEL = 3            #channel on the 9685 pwm board 0-15
STEERING_UP_LEFT_PWM = 600         #pwm value for full left steering
STEERING_UP_RIGHT_PWM = 0        #pwm value for full right steering
...
JOYSTICK_STEERING_UP_SCALE = 1.0
JOYSTICK_STEERING_DOWN_SCALE = 1.0
